...
const TD_contract_json2 = require('/Users/sid_mukkamala/Documents/Thesis2/code/truffleprojects/truffleanew/build/contracts/TruthDiscovery.json');
...
const weightupdate = async () => {
	...
	console.log("THIS SHOULD BE A VALUE",pt_value)
...
const get_finaltruth = async () => {
	...
	// Using final_truth, update the weights
	worker_update(Workers,value, value2);
	// console.log(Workers)
